		...
		<!------start-768px-menu---->
			...
			<div class="banner" id="move-top">
				...
				<!---scrooling-script--->
					...
					<div class="simple-text">
						<div class="wrap">
							<h4>Fashion Shop provides latest designs in the clothing industry</h4>
			...
			<div class="Recent-wroks"><!-- start services -->
				...
				<div class="Recent-wrok">
					<h5 class="heading">Recent work</h5>
					<!----start-img-cursual---->
<div id="owl-demo" class="owl-carousel">
<?php
include './db.php';
$result = mysqli_query($link, "select pimage,subcat,descr from products") or die(mysqli_error($link));
if(mysqli_num_rows($result)>0) {
while($row = mysqli_fetch_row($result)) {
?>
<div class="item">
<div class="cau_left">
<img src="<?php echo $row[0]?>" style="width: 200px; height:200px;">
</div>
<div class="cau_left">
			...
			<div class="footer">
				<div class="wrap">
					...
					<div class="footer-right">
						<h3>Twitter</h3>
						<div class="comments1">
							<p>For more information in Fashion shop. Visit us on the Twitter. Follow us for more information such as new arrivals, fachions and kids wear...</p>
